...
export default function AgentPage() {
  ...
  return (
    <div className="h-[calc(100vh-64px)] flex flex-col gap-4 p-4 lg:p-6 overflow-hidden">
      <div className="flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900">Clean Freaks AI Agent</h1>
            <p className="text-xs text-gray-500">Daily operations coach · Powered by Claude</p>
          </div>
        </div>
