      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-3">
            ...
            <JobStatusUpdater jobId={job.id} currentStatus={job.status} providers={[]} currentProviderId={job.provider_id || null} customerId={job.customer_id || null} businessId={profile?.business_id || null} scheduledAt={job.scheduled_at} timezone={job.location?.timezone || business?.timezone || 'Australia/Melbourne'} />
          </div>
